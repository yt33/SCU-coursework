    sa::_iterativeUtils::setSkipIterations  /DCNFS/users/student/yli1/simulation/lab3/inverter_tb/schematic/HSPICE/nominal/results {}
...
namespace eval ss {
    ...
    sa::_resultsDatabase::_loadSetupForMeasurementCalculation [getActiveTestbench] /DCNFS/users/student/yli1/simulation/lab3/inverter_tb/schematic/HSPICE/nominal HSPICE
    sa::_utils::setDataDir -of [getActiveTestbench] -value /DCNFS/users/student/yli1/simulation/lab3/inverter_tb/schematic/HSPICE/nominal 
    set session [getActiveSession]
    set sessionScope [sa::_utils::getSessionScope $session]
    set prefsFile [file join [file dirname /DCNFS/users/student/yli1/simulation/lab3/inverter_tb/schematic/HSPICE/nominal/results] [::sa::_coreUtils::getSavedSessionPrefsFileName]]
    ...
    sa::_cacheUtils::setSessionHintForSAEShell saeSession3 
    proc _runMeasurements {} {
        catch {
        sa::_resultsDatabase::processSimulationCheckResults [getActiveTestbench]
        sa::_resultsDatabase::_doRunMeasurements /DCNFS/users/student/yli1/simulation/lab3/inverter_tb/schematic/HSPICE/nominal/resultsDatabase false 1 /DCNFS/users/student/yli1/simulation/lab3/inverter_tb/schematic/HSPICE/nominal/results /DCNFS/users/student/yli1/simulation/lab3/inverter_tb/schematic/HSPICE/nominal/results 1
        } ::scriptError
    }
