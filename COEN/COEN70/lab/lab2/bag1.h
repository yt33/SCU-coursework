...
//
//   void operator -=(const bag& s2)
//     Precondition:  non
//     Postcondition: Any items from s2 has been removed from this bag.
//
//
...
//   bag operator -(const bag& b1, const bag& b2)
//     Precondition:  non
//     Postcondition: For two bags b1 and b2, the bag b1 - b2 contains all of the
//                    items of b1, with any items from b2 removed.
//
//
