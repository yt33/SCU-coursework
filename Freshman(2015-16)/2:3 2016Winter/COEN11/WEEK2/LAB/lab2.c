/* Yutong Li
   ...
   THURSDAY 9:15AM
	...
	Restaurant waiting list: can reserve and "free" reservation
	1 - reserve (enter name and party size)
	2 - assign table to the waiting list (enter table size)
	3 - list the existing reservation
	otherwise - quit
...
int main()
{
	...
	{
		printf("\nWelcome to Babadook\n");
		printf("Enter '1' to reserve, '2' to assign table, '3' to list the existing reservation, anything else to quit\n");
		scanf ("%d",&pos);
